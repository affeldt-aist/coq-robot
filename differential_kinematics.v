...
Lemma derive1_cst (R : realFieldType) (V : normedModType R) (f : V) t : (cst f)^`() t = 0.
...
Variables (R : realFieldType) (M : R -> 'M[R^o]_3). (* time-varying matrix *)
  ...
  - rewrite !crossmulDr !crossmulvZ !crossmulZv !Hzvec veckj vecki !scalerN.
    ...
    - rewrite !scalerA -2!scalerDl row3e1; congr (_ *: _).
      ...
      rewrite -mulrDr [in RHS]derive1E deriveD; last 2 first.
        exact: H2.
        exact: H1.
      rewrite -mulrA scale_realType; congr (a2 * _).
