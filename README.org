...
- [[https://coq.inria.fr/][The Coq proof-assistant]] 8.9.0
- [[https://github.com/math-comp/math-comp][The Mathematical Components library]] 1.8.0
- [[https://github.com/affeldt-aist/real-closed][Theorems for real closed fields]] (fork)
  + requires [[https://github.com/math-comp/bigenough][bigenough]] first release
- [[https://github.com/math-comp/analysis][Analysis library compatible with Mathematical Components]] master version
  + requires bigenouh and [[https://github.com/math-comp/finmap][finmap]] 1.2.0
