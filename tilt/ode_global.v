...
Hypothesis sol_oo : forall t, t \in `[a, b[%R ->
  is_sol_cauchy_oo phi a t u0 sol.
...
Let sol0 : sol a = u0.
Proof.
have /sol_oo : a \in `[a, b[%R by rewrite bound_itvE.
by case.
Qed.
...
exists x => //.
move: xab; rewrite !in_itv/= => /andP[/ltW -> /=].
